...
class GetTopicWithSubscribeStatusUseCaseTest{
    ...
    @Test
    fun getTopicWithSubscribeStatusSuccesfully() = coroutineRule.runBlockingTest {
        val useCase = GetTopicWithSubscribeStatusUseCase(coroutineRule.testDispatcher,succesTopicRepository)
    ...
    @Test
    fun getTopicWithSubscribeStatusUnSuccesfully() = coroutineRule.runBlockingTest {
        val useCase = GetTopicWithSubscribeStatusUseCase(coroutineRule.testDispatcher,unsuccesfulTopicRepository)
        val result = useCase(Unit)
    ...
    private val succesTopicRepository = object : ITopicRepository {
        override suspend fun getDefaultTopic(): List<TopicNet> =dummyTopicNet
        ...
        override suspend fun getSubscribedTopic(): List<String> = dummyTopicNet.map { it.topicName }
    }
}